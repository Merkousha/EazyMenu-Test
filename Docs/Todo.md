...
- [ ] پیاده‌سازی Use Caseها و ریپازیتوری EF Core منو بر اساس سند طراحی (Application + Infrastructure).
	- پیشرفت: فرمان‌ها و کوئری‌های منو در لایه Application تکمیل شد؛ نگاشت EF Core (کانورترها، ValueComparerها، مالکیت دسته/آیتم) اضافه شد؛ گام بعد پیاده‌سازی ریپازیتوری و مایگریشن `AddMenus` است.
