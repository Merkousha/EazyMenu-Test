...
public sealed class RemoveBranchTableCommandHandler : ICommandHandler<RemoveBranchTableCommand, bool>
{
    private readonly IBranchRepository _branchRepository;
    private readonly IUnitOfWork _unitOfWork;

    public RemoveBranchTableCommandHandler(IBranchRepository branchRepository, IUnitOfWork unitOfWork)
    {
        _branchRepository = branchRepository;
        _unitOfWork = unitOfWork;
    }

    public async Task<bool> HandleAsync(RemoveBranchTableCommand command, CancellationToken cancellationToken = default)
    {
