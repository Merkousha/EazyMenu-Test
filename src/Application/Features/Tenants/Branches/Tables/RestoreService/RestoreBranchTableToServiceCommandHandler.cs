...
public sealed class RestoreBranchTableToServiceCommandHandler : ICommandHandler<RestoreBranchTableToServiceCommand, bool>
{
    private readonly IBranchRepository _branchRepository;
    private readonly IUnitOfWork _unitOfWork;

    public RestoreBranchTableToServiceCommandHandler(IBranchRepository branchRepository, IUnitOfWork unitOfWork)
    {
        _branchRepository = branchRepository;
        _unitOfWork = unitOfWork;
    }

    public async Task<bool> HandleAsync(RestoreBranchTableToServiceCommand command, CancellationToken cancellationToken = default)
    {
        ...
        branch.RestoreTableToService(tableId);
