...
public sealed class CompleteOrderCommandHandler : ICommandHandler<CompleteOrderCommand, bool>
{
    ...
    public async Task<bool> HandleAsync(CompleteOrderCommand command, CancellationToken cancellationToken = default)
    {
