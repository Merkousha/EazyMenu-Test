...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EazyMenu.Domain.Aggregates.Menus.Menu", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("EazyMenu.Domain.Aggregates.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EazyMenu.Domain.Aggregates.Reservations.Reservation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("NoShowRecordedAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("TenantId", "BranchId", "TableId", "Status");
            ...
            modelBuilder.Entity("EazyMenu.Domain.Aggregates.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("EazyMenu.Infrastructure.Persistence.Models.MenuPublication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "MenuId", "Version")
                        .IsUnique();

                    b.ToTable("MenuPublications", (string)null);
                });
            ...
            modelBuilder.Entity("EazyMenu.Domain.Aggregates.Menus.Menu", b =>
                {
                    ...
                    b.OwnsMany("EazyMenu.Domain.Aggregates.Menus.MenuCategory", "Categories", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasIndex("MenuId", "DisplayOrder")
                            ...
                            b1.OwnsMany("EazyMenu.Domain.Aggregates.Menus.MenuItem", "Items", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .HasColumnType("uniqueidentifier");
                                    ...
                                    b2.Property<string>("_channelPrices")
                                        .IsRequired()
                                        .HasColumnType("nvarchar(max)")
                                        .HasColumnName("ChannelPrices");

                                    b2.Property<string>("_tags")
                                        .IsRequired()
                                        .HasColumnType("nvarchar(256)")
                                        .HasColumnName("Tags");
                                    ...
                                    b2.HasIndex("CategoryId", "DisplayOrder")
                                    ...
                                    b2.OwnsOne("EazyMenu.Domain.ValueObjects.Money", "BasePrice", b3 =>
                                        {
            ...
            modelBuilder.Entity("EazyMenu.Domain.Aggregates.Orders.Order", b =>
                {
                    b.OwnsMany("EazyMenu.Domain.Aggregates.Orders.OrderItem", "Items", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EazyMenu.Domain.Aggregates.Reservations.Reservation", b =>
                {
                    b.OwnsOne("EazyMenu.Domain.ValueObjects.ScheduleSlot", "ScheduleSlot", b1 =>
                        {
                    ...
                    b.OwnsMany("EazyMenu.Domain.Aggregates.Reservations.ReservationStatusHistoryEntry", "StatusHistory", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.ToTable("ReservationStatusHistory", (string)null);
                    ...
                    b.OwnsOne("EazyMenu.Domain.ValueObjects.BrandProfile", "Branding", b1 =>
                        {
                            ...
                            b1.Property<string>("OpeningHours")
                                .HasMaxLength(500)
                                .HasColumnType("nvarchar(500)")
                            ...
                            b1.Property<string>("TemplateName")
                                .IsRequired()
                                .HasMaxLength(100)
                                .HasColumnType("nvarchar(100)")
            ...
            modelBuilder.Entity("EazyMenu.Domain.Aggregates.Users.User", b =>
                {
                    b.OwnsOne("EazyMenu.Domain.Aggregates.Users.PasswordHash", "PasswordHash", b1 =>
                        {
                    ...
                    b.OwnsOne("EazyMenu.Domain.ValueObjects.PhoneNumber", "PhoneNumber", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uniqueidentifier");
